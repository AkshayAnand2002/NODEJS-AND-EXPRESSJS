...
//post requests ask server to store data which is stored in the body of requests.
//often used when adding data to db.
...
app.post('/about', urlencodedParser, (req, res) => {
    console.log(req.body); //it will print what the user on the http://127.0.0.1:3000/about website fills in the required spaces.
    res.render('about', { qs: req.query }); //middleware storing the function.
});
