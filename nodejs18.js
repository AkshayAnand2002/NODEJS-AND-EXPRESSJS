//Using ejs we can pass data to an object as a second parameter to render method.
//we can pass properties to the object which will contain only one object and then the data in it.
...
app.get('/profile/:name', (req, res) => { //if we give any name after writing profile then that is printed on screen.
    ...
    res.render('profile1', { person: req.params.name });
