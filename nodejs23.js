...
//Middleware is the sending of code that runs between request and response.
//If we directly link css files with ejs files they will not work.
//So, we use a middleware i.e. .use function. which is not an inbuilt version.
//Express JS has inbuilt middleware called express.static .
//When we link assets file to the express.static we will be able to use assets css file in every .ejs file .
